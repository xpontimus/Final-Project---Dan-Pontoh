...
waste_long <- gather(waste, party, count, -contested, -id)

waste_long <- filter(waste_long, contested == TRUE)
...
gg <- gg + labs(x = NULL, y = NULL,
                title = "Only Contested Wasted Votes (NH General State House 2014)") #
gg <- gg + theme_bw() 
